...
void main() {
    ...
    vec2 topLeft = center + vec2(-radius, radius);   // Top-left corner
    vec2 topRight = center + vec2(radius, radius);   // Top-right corner
    vec2 bottomLeft = center + vec2(-radius, -radius); // Bottom-left corner
    vec2 bottomRight = center + vec2(radius, -radius); // Bottom-right corner
